...
$redirect_uri = "https://node73.webte.fei.stuba.sk/zad1/oauth2callback.php"; // Redirect URI for the OAuth2 callback. Must match the one in the Google Cloud Console.
...
if (isset($_GET['code'])) {
    ...
    $redirect_uri = "https://node73.webte.fei.stuba.sk/zad1/restricted.php"; // Redirect to the restricted page or dashboard.
