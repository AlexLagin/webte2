<?php
    ...
    $csvData = parseCSV('csvs/nobel_v5.2_LIT.csv');
    ...
    foreach ($csvData as $row) {
        ...
        list($prize_year, $name, $surname, $sex, $birth, $death, $country, $contrib_sk, $contrib_en, $language_sk, $language_en, $genre_sk, $genre_en) = $row;
        ...
        $status = insertLaureateWithCountryAndPrize($db, $name, $surname, NULL, $sex, $birth, $death,
            $country, $language_sk, $language_en, $genre_sk, $genre_en,
